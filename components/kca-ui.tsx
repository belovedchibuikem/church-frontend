          ...
          <KcaAdmissionLetterSheet
            ...
            fallbackHeader={(
              <>
                ...
                <div>
                  <strong>{t('member.kca.academyName', { defaultMessage: 'KINGDOM CHANGE AGENT' })}</strong>
