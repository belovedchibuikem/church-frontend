...
import { adminOperatorHomeHref, evaluateAccess, resolveAdminGuestLoginRedirect } from '../../../lib/access-control';
...
export default async function AdminPage({
  ...
  if (route === '/admin') {
    const operatorHome = adminOperatorHomeHref(context);
    if (operatorHome) {
      redirect(operatorHome);
    }
  }
