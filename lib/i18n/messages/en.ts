...
export const en: MessageTree = {
  ...
  bible: {
    ...
    subtitle: 'Read Scripture, follow a paced plan, and see today’s target in one place.',
    searchPlaceholder: 'Search a word or John 3:16',
    today: 'Today’s reading',
    libraryTitle: 'Holy Scripture',
    choosePlanCopy: 'Choose 3 months, 6 months, 1 year, 2 years, or create your own pace.',
    signInForPlans: 'Sign in to start a reading plan and track today’s target.',
    customPlan: 'Create your own pace',
    customPlanCopy: 'Choose how many days you want to finish the Bible (30–1,095).',
    startCustomPlan: 'Start custom plan',
    versionUnavailable: '{name} is not installed on this church server yet. KJV remains available.',
    plans: 'Reading plans',
    continueReading: 'Continue reading',
    startJohn: 'Start in John 1',
    planLead: 'Finish the whole Bible at a pace that fits your life.',
    choosePlan: 'Choose a plan',
    oldTestament: 'Old Testament',
    newTestament: 'New Testament',
    dayOf: 'Day {day} of {total}',
    catchUp: 'Catch up first — {count} missed day(s) still due.',
    planComplete: 'You have finished this plan. Well done.',
    markDone: 'Mark today complete',
    planDays: '{days} days',
    startPlan: 'Start this plan',
    chooseBook: 'Choose book',
    chooseChapter: 'Choose chapter',
    unavailable: 'The Bible is unavailable right now. Try again shortly.',
    searching: 'Searching…',
    noResults: 'No verses matched that search.',
    filterBooks: 'Find a book',
    allBooks: 'All books',
    noBooks: 'No books match that name.',
