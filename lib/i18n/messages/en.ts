...
export const en: MessageTree = {
  ...
  bible: {
    ...
    searchPlaceholder: 'Try John 3:16 or a word like faith',
    today: 'Today’s reading',
    choosePlanCopy: 'Choose a 1, 2, or 3 year plan and we will give you a daily target.',
    plans: 'Reading plans',
    signInForPlans: 'Sign in to start a yearly plan and track today’s target.',
