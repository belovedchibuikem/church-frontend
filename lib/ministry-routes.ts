...
export const ministryScreens: AdminScreen[] = [
  ...
  { id: 'E-27', batch: 'E', route: '/admin/church/finance', title: 'Church Finance', subtitle: 'Link to the canonical Finance module.', kind: 'finance', permission: 'church.finance.view', scope: 'assigned', nav: 'finance' },
