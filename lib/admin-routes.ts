...
export const adminScreens: AdminScreen[] = [
  ...
  { id: 'A-10', batch: 'A', route: '/admin/audit', title: 'Audit Summary', subtitle: 'Overview of system audit and compliance.', kind: 'kpi', permission: 'security.audit.view', scope: 'assigned', nav: 'audit', metrics: [{ label: 'Total Audit Logs', value: '256,832' }, { label: 'Admin Actions', value: '18,542' }, { label: 'Data Changes', value: '12,371' }, { label: 'Login Events', value: '225,919' }], items: ['Church Approvals — 3,254', 'Member Approvals — 2,031', 'Content Management — 1,994', 'User Management — 1,732', 'Financial Actions — 1,421'] },
  ...
  { id: 'A-15', batch: 'A', route: '/admin/profile', title: 'Admin Profile', subtitle: 'Manage your admin account.', kind: 'profile', permission: 'member.self.manage', scope: 'self', nav: 'dashboard', details: { 'Full Name': 'John Chinedu Doe', 'Email Address': 'admin@fhconnect.org', Role: 'Super Administrator', 'Phone Number': '+234 801 234 5678', 'Time Zone': '(WAT) West Africa Time', Language: 'English', 'Account Status': 'Active', 'Last Login': 'May 12, 2024 · 09:24 AM', 'Member Since': 'Jan 15, 2023' }, action: 'Update Profile' },
  ...
  { id: 'B-01', batch: 'B', route: '/admin/users', title: 'Users', subtitle: 'Manage all platform users across the global scope.', kind: 'table', permission: 'identity.user.view', scope: 'assigned', nav: 'users', action: '+ Create User', metrics: [{ label: 'All Users', value: '24,580' }, { label: 'Active', value: '21,344' }, { label: 'Suspended', value: '1,235' }, { label: 'Pending', value: '2,001' }], columns: ['User', 'Email / Phone', 'Role', 'Church / Org', 'Status', 'Last Active'], rows: users },
  { id: 'B-02', batch: 'B', route: '/admin/users/john-chinedu-doe', title: 'John Chinedu Doe', subtitle: 'Member · Active', kind: 'detail', permission: 'identity.user.view', scope: 'assigned', nav: 'users', tabs: ['Overview', 'Profile', 'Roles & Permissions', 'Activity', 'Giving', 'Churches', 'More'], details: { 'Member ID': 'FHC-0002315', Email: 'john.doe@email.com', Phone: '+234 803 123 4478', Location: 'Lagos, Nigeria', 'Member Of': 'Grace Home Church', 'Account Status': 'Active', 'Last Active': 'May 12, 2024 09:34 AM', 'Total Logins': '166' }, items: ['Member — Home Church Member', 'Grace Home Church — Member', 'Kingdom Family — Member'] },
  ...
  { id: 'B-10', batch: 'B', route: '/admin/permissions', title: 'Permissions', subtitle: 'Manage all system permissions.', kind: 'permissions', permission: 'identity.permission.view', scope: 'global', nav: 'access', items: ['Dashboard', 'Users', 'Churches', 'Events', 'Giving', 'KCA', 'Reports', 'Settings'] },
  { id: 'B-11', batch: 'B', route: '/admin/permissions/matrix', title: 'Permission Matrix', subtitle: 'Compare roles and their permissions.', kind: 'matrix', permission: 'identity.permission.view', scope: 'global', nav: 'access' },
  { id: 'B-12', batch: 'B', route: '/admin/access/scope-assignments', title: 'Scope Assignments', subtitle: 'Define scope hierarchy access for roles or users.', kind: 'form', permission: 'organization.scope.assign', scope: 'assigned', nav: 'access', tabs: ['By Role', 'By User'], action: 'Save Scope' },
